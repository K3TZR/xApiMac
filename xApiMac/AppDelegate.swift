...
@NSApplicationMain
class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject, LogManagerDelegate, NSWindowDelegate {
    // ----------------------------------------------------------------------------
    ...
    func applicationDidFinishLaunching(_ aNotification: Notification) {
        // instantiate the RadioManager and give it access to the Tester
